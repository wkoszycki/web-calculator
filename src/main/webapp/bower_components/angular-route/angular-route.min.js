...
(function (n, e, A) {
    ...
    function z(e, g, h) {
        return {
            restrict: "ECA", priority: -400, link: function (a, c) {
                ...
                c.html(f.$template);
                var w = e(c.contents());
                b.controller && (f.$scope = a, f = g(b.controller, f), b.controllerAs
                                                                       && (a[b.controllerAs] =
                                                                           f), c.data("$ngControllerController",
                                                                                      f), c.children().data("$ngControllerController",
                                                                                                            f));
                w(a)
            }
        }
    ...
    n = e.module("ngRoute", ["ng"]).provider("$route", function () {
        ...
        function g(a, e) {
            ...
            a =
            a.replace(/([().])/g, "\\$1").replace(/(\/)?:(\w+)([\?\*])?/g, function (a, e, b, c) {
                a = "?" === c ? c : null;
                c = "*" === c ? c : null;
        ...
        ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache",
         "$sce", function (a, c, b, f, g, n, v, k) {
            function l() {
                var d = p(), m = r.current;
                if (d && m && d.$$route === m.$$route && e.equals(d.pathParams, m.pathParams)
                    && !d.reloadOnSearch && !u) {
                    m.params = d.params, e.copy(m.params,
                                                b), a.$broadcast("$routeUpdate",
                                                                 m);
                } else if (d
                           || m) {
                    u = !1, a.$broadcast("$routeChangeStart",
                        ...
                        : c.url(d.redirectTo(d.pathParams, c.path(),
                                             c.search())).replace()), f.when(d).then(function () {
                        if (d) {
                            var a = e.extend({}, d.resolve), c, b;
                            e.forEach(a, function (d, c) {
                                a[c] = e.isString(d) ? g.get(d) : g.invoke(d)
                            });
                            e.isDefined(c = d.template) ? e.isFunction(c) && (c = c(d.params))
                                : e.isDefined(b = d.templateUrl) && (e.isFunction(b) && (b =
                                                                                         b(d.params)), b =
                                                                                                       k.getTrustedResourceUrl(b), e.isDefined(b)
                                                                                                                                   && (d.loadedTemplateUrl =
                                                                                                                                       b, c =
                                                                                                                                          n.get(b,
                        ...
                        d == r.current && (d && (d.locals = c, e.copy(d.params,
                                                                      b)), a.$broadcast("$routeChangeSuccess",
                                                                                        d, m))
                    }, function (c) {
            ...
            function p() {
                ...
                e.forEach(h, function (f, h) {
                    ...
                    q && (b =
                          s(f, {params: e.extend({}, c.search(), a), pathParams: a}), b.$$route = f)
                });
